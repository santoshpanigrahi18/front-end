...
import footerlogo from "../../../assets/utils/images/DPDHL_Group_One_line_logo_rgb.png";
    ...
    return (
      <Fragment>
        <div className="footer-dots" >
           <img src={footerlogo} alt="DPDHL_footer-logo" className="ft-logo"/>
          {/* <a href="#" className="dot-btn-wrapper">
          ...
          <a href="#" className={`dot-btn-wrapper ${colorScheme=='dark'&&'text-white'}`}>
...
export default connect(mapStateToProps, mapDispatchToProps)(FooterDots);
